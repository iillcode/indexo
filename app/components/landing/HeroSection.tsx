  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        <section>
          <div className="relative mx-auto max-w-7xl px-6 pt-32 lg:pb-16 lg:pt-32 md:px-16 lg:px-24">
            <div className="relative z-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                {/* Left Column - Text Content */}
                <div className="text-left">
                  <div>
                    <h1 className="text-balance text-4xl font-medium sm:text-5xl md:text-6xl leading-tight">
                      Build & Deploy{" "}
                      <span className="bg-gradient-to-b from-orange-500 to-orange-600 text-transparent bg-clip-text flex flex-row items-center gap-2">
                        <span>
                          <img
                            className="h-14 w-14 bg-gradient-to-b from-orange-500 to-orange-600 rounded-full"
                ...
                {/* Right Column - Image/App Preview */}
  ...
  return (
    <header>
      ...
      >
        <div
          className={cn(
            "mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-7",
            isScrolled &&
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full justify-between lg:w-auto lg:flex-1">
              <div className="flex items-center space-x-8">
                ...
                {/* Navigation menu next to logo - only when not scrolled */}
                <div className={cn("hidden", !isScrolled && "lg:block")}>
            ...
            {/* Center navigation menu when scrolled */}
            <div
              className={cn(
                "absolute inset-0 m-auto hidden size-fit",
                isScrolled && "lg:block"
              )}
            >
              <ul className="flex gap-8 text-sm">
...
const LogoCloud = () => {
  return (
    <section className="bg-[#101010] pb-16 md:pb-32 px-8 md:px-16">
      <div className="group relative m-auto max-w-6xl">
        <div className="flex flex-col items-center md:flex-row">
          <div className="inline md:max-w-44 md:border-r md:pr-6">
            <p className="text-end text-sm text-foreground">
          ...
          <div className="relative  py-6 md:w-[calc(100%-11rem)]">
            ...
            <div className="bg-gradient-to-r from-[#101010] absolute inset-y-0 left-0 w-20"></div>
            <div className="bg-gradient-to-l from-[#101010] absolute inset-y-0 right-0 w-20"></div>
            <ProgressiveBlur
  ...
  return (
    <>
      <div className="flex flex-row  justify-center items-center gap-2">
        <img className="w-10 h-10" src="/app.icon.svg" alt="" />
        <span className="font-bold text-white">Indexo</span>
      </div>
    </>
  );
};
