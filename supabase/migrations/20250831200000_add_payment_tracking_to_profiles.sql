...
-- Create index for paid users lookup
...
-- Create function to update user payment status
...
-- Create function to check if user can make payment (prevent multiple payments)
...
-- Create function to get user payment info
